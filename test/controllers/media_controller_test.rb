...
#       post media_url, params: { medium: { candidate: @medium.candidate, headline: @medium.headline, url: @medium.url } }
#     end
#
...
#     patch medium_url(@medium), params: { medium: { candidate: @medium.candidate, headline: @medium.headline, url: @medium.url } }
